...
function createOrg1() {
  ...
  CMP_CA_TLS_FILE=${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/org1.example.com/
  #  rm -rf $FABRIC_CA_CLIENT_HOME/fabric-ca-client-config.yaml
  #  rm -rf $FABRIC_CA_CLIENT_HOME/msp

  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca-org1 --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client register --caname ca-org1 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-org1 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-org1 --id.name org1admin --id.secret org1adminpw --id.type admin --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca-org1 -M "${CMP_HOME_DIR}"/msp --csr.hosts peer0.org1.example.com --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca-org1 -M "${CMP_HOME_DIR}"/tls --enrollment.profile tls --csr.hosts peer0.org1.example.com --csr.hosts localhost --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:7054 --caname ca-org1 -M "${FABRIC_CA_CLIENT_HOME}"/users/User1@org1.example.com/msp --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://org1admin:org1adminpw@localhost:7054 --caname ca-org1 -M "${FABRIC_CA_CLIENT_HOME}"/users/Admin@org1.example.com/msp --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  CMP_CA_TLS_FILE=${PWD}/organizations/fabric-ca/ordererOrg/tls-cert.pem
  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/ordererOrganizations/example.com
  #  rm -rf $FABRIC_CA_CLIENT_HOME/fabric-ca-client-config.yaml
  #  rm -rf $FABRIC_CA_CLIENT_HOME/msp

  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:9054 --caname ca-orderer --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client register --caname ca-orderer --id.name orderer --id.secret ordererpw --id.type orderer --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null

  infoln "Registering the orderer admin"
  set -x
  fabric-ca-client register --caname ca-orderer --id.name orderer-Admin --id.secret orderer-Admin-pw --id.type admin --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M "${CMP_HOME_DIR}"/msp --csr.hosts orderer.example.com --csr.hosts localhost --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M "${CMP_HOME_DIR}"/tls --enrollment.profile tls --csr.hosts orderer.example.com --csr.hosts localhost --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M "${FABRIC_CA_CLIENT_HOME}"/users/Admin@example.com/msp --tls.certfiles "${CMP_CA_TLS_FILE}"
  { set +x; } 2>/dev/null
